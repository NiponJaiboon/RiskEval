...
namespace BBAnalysisWeb.Controllers
{
    ...
    public class ReportController : BaseController
    {
        ...
        //รายงานภาพรวมทั่วประเทศ แยกตามโครงการที่อยู่ในข่าย/ไม่อยู่ในข่ายการวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล
        public ActionResult ProjectGroupByRiskAnalysisReport(int projectId)
        {
            this.Tab = "1";
            Project project = Project.GetProjectByID(SessionContext, projectId);

            Session["ProjectGroupByRiskAnalysisReport"] = project;
            return View();
        }    

        public override int pageID
        {
            get { return PageID.Report; }
        }
    }
}