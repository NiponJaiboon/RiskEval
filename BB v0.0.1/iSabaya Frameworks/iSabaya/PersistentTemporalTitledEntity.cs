...
namespace iSabaya
{
    ...
    public abstract class PersistentTemporalTitledEntity : PersistentTemporalEntity
    {
        ...
        public PersistentTemporalTitledEntity(TimeInterval effectivePeriod, String code, MultilingualString title, MultilingualString description, String reference, String remark)
