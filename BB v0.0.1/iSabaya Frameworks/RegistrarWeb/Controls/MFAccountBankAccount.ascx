<%@ Control Language="C#" AutoEventWireup="true" Inherits="ctrls_MFAccountBankAccount"
    CodeBehind="MFAccountBankAccount.ascx.cs" %>
        ...
        <td>
            <dx:ASPxComboBox ID="cbxBankAccount" runat="server" Width="320" DropDownWidth="600"
                ...
                <Columns>
                    ...
                    <dx:ListBoxColumn FieldName="BranchName" Name="BranchName" Caption="สาขา" Width="60" />
