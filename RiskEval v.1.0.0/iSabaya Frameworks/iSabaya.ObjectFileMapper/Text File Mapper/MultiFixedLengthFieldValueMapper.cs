...
{
    public class MultiFixedLengthFieldValueMapper<V> : FieldValueMapper<V>, IMultiFieldValueMapper<V>
        where V : class, new() 
    {
        //public virtual TextFieldType<V> FieldType { get; set; }

        internal FixedLengthFieldMapper<V> signatureFieldMapper;
        ...
        internal FixedLengthFieldMapper<V>[] fieldMappers;
        /// <summary>
