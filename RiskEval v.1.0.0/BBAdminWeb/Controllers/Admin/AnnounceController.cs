...
namespace BBAdminWeb.Controllers
{
    ...
    /// <summary>
    /// Announce controller is management of announces
    ...
    public class AnnounceController : BaseController
    {
        ...
        public JsonResult Save(string headLine, string content)
        {
            ...
            using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    SessionContext.LogButNotFlush(0, this.pageID, 0, MessageException.AnnounceMessage.Save, MessageException.Fail(ex.Message));
        ...
        public JsonResult Update(long id, string headLine, string content)
        {
            ...
            using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    SessionContext.LogButNotFlush(0, this.pageID, 0, MessageException.AnnounceMessage.Update, MessageException.Fail(ex.Message));
                    return Json(new { Success = false, Message = MessageException.Error }, JsonRequestBehavior.AllowGet);
                }
            }
        ...
        public JsonResult Delete(long id)
        {
            ...
            using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    SessionContext.LogButNotFlush(0, this.pageID, 0, MessageException.AnnounceMessage.Delete, MessageException.Fail(ex.Message));
                    return Json(new { Success = false, Message = MessageException.Error }, JsonRequestBehavior.AllowGet);
                }
            }
        ...
        public override int pageID { get { return PageID.AnnounceManagement; } }
    }
}