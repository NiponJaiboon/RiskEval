...
namespace BBWeb.Controllers
{
    public class UserController : BaseController
    {
                    ...
                    if (u != null)
                        using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                SessionContext.Log(0, this.pageID, 0, MessageException.UserMessage.Disable, MessageException.Fail(ex.Message));
                            }
                        }
                }
                message.Append("</ul>");
                    ...
                    if (u != null)
                        using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                SessionContext.Log(0, this.pageID, 0, MessageException.UserMessage.Enable, MessageException.Fail(ex.Message));
        ...
        {
            get { return PageID.UserManagement; }
        }
    }
}