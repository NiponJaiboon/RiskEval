...
namespace BBWeb.Controllers
{
    public class StrategicController : BaseController
    {
            ...
            try
            {
                ...
                using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        SessionContext.Log(0, this.pageID, 0, MessageException.StrategicMessage.Save, MessageException.Fail(ex.Message));
                        return Json(new { Success = false, Message = MessageException.Error }, JsonRequestBehavior.AllowGet);
                    }
                }
            }
            ...
            try
            {
                ...
                using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        SessionContext.Log(0, this.pageID, 0, MessageException.StrategicMessage.Update, MessageException.Fail(ex.Message));
                        return Json(new { Success = false, Message = MessageException.Error }, JsonRequestBehavior.AllowGet);
                    }
                }
            }
            ...
            try
            {
                ...
                using (ITransaction tx = SessionContext.PersistenceSession.BeginTransaction())
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        SessionContext.Log(0, this.pageID, 0, MessageException.StrategicMessage.Delete, MessageException.Fail(ex.Message));
                        return Json(new { Success = false, Message = MessageException.Error }, JsonRequestBehavior.AllowGet);
                    }
                }
            }
        ...
        {
            get { return PageID.StrategicManagement; }
        }
    }
}