<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true"
    CodeFile="question_set_D.aspx.cs" Inherits="question_set_D" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     ...
     <div class="box-question">
        <div style="text-align: left; margin-top: 10px;">
            ...
            <div style="display:none">
                <asp:Literal ID="lblAssumption7" runat="server"></asp:Literal>
                </div>
            ...
            <asp:Panel ID="pnl7_3" runat="server">
                <div style="margin-left: 15px; margin-top: 15px;">
                    ...
                    <div style="margin-left: 10px">
                        ...
                        <div style="margin: 5px 5px 5px 5px; text-align: center;">
                        <asp:Button ID="btnToQ8_4" runat="server" OnClick="btnToQ8_4_Click" Text="บันทึกและดำเนินการต่อไป"
                         OnClientClick="if (Page_ClientValidate()){ return confirm('ต้องการบันทึกและดำเนินการต่อไป')}"/>
                        </div>
                    </div>
                </div>
    ...
    <asp:Panel ID="panel2" runat="server" Visible="false">
     <div class="box-question">
        ...
        <div style="display:none">
                <asp:Literal ID="lblAssumption8" runat="server"></asp:Literal></div>
            ...
            <asp:Panel ID="pnl8_4" runat="server">
                <div style="margin-left: 15px; margin-top: 15px;">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Text="*"
                        ErrorMessage="กรุณาเลือกมี หรือ ไม่มี" SetFocusOnError="true" Display="Dynamic" CssClass="ErrorDokJan"
                    ...
                    <div style="margin-left: 10px">
                        ...
                        <p>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtAnswerQuestion8_4_1"
                                ErrorMessage="ห้ามเกิน 1500 ตัวอักษร" Display="Dynamic" SetFocusOnError="true"
                                ValidationExpression="^[a-zA-Z0-9ก-๙\x22\s\.\+\(\)\-\:,\=\%\w\d/\\/]{0,1500}$">
                            </asp:RegularExpressionValidator>
                        </p>
    ...
    <asp:Panel ID="panel3" runat="server" Visible="false">
     <div class="box-question">
        ...
        <div style="text-align: left; margin-top: 10px;">
            ...
            <asp:Literal ID="lblAssumption9" runat="server"></asp:Literal>
            </div>
            <div style="margin-left: 15px; margin-top: 15px;">
                ...
                <asp:Panel ID="pnl9_6" runat="server">
                    ...
                    <div style="margin: 5px 5px 5px 5px; text-align: center;">
                        <asp:Button ID="btnToSetE" runat="server" Text="บันทึกข้อมูลและดำเนินงานต่อไป" OnClick="btnToSetE_Click" />
                    </div>
                </asp:Panel>
            </div>
        </div>
