...
public partial class projects_sim_completed_not_submitted : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dgProject.DataSource = pj.getProjectInfoAll_Sim_Completed_notSubmitted(ck.p_id);
        dgProject.DataBind();
