<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="projects_completed_approved.aspx.cs" Inherits="projects_completed_approved" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
การวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล ตามแผนงาน/โครงการ  โครงการที่สำนักงบประมาณ
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
    โครงการที่สำนักงบประมาณ
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="dgProject" runat="server" AutoGenerateColumns="false" OnRowDataBound="dgProject_OnRowDataBound">
        <Columns>
            ...
            <asp:HyperLinkField DataTextField ="pj_name" DataNavigateUrlFields ="pj_id" DataNavigateUrlFormatString ="redirectProjects.aspx?pj_id={0}" HeaderText="ชื่อโครงการ"  ItemStyle-Width="350px"/>
            ...
            <asp:BoundField HeaderText="ผลการประเมินการวิเคราะห์ความเสี่ยง"  ItemStyle-HorizontalAlign="Center" />
