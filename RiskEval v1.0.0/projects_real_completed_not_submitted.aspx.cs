...
public partial class projects_real_completed_not_submitted : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dgProject.DataSource = pj.getProjectInfoAll_Real_Completed_notSubmitted(ck.p_id);
        dgProject.DataBind();
