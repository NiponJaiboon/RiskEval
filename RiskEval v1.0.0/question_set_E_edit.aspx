<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="question_set_E_edit.aspx.cs" Inherits="question_set_E_edit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
การวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล ตามแผนงาน/โครงการ คำถามชุด จ
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
คำถามชุด จ: การจัดลำดับและจัดสรรงบประมาณโครงการ
</asp:Content>
                ...
                <asp:TextBox ID="txtAnswerQuestion3_1" CssClass="TextArea" runat="server"  TextMode="MultiLine" Rows="7" Columns="70" MaxLength="1500"></asp:TextBox>
                     <asp:RequiredFieldValidator 
                        ...
                        Text="*" 
                         Display="Dynamic"
                          SetFocusOnError="true"
                        ErrorMessage="กรุณากรอกคำตอบข้อ1.1" CssClass="ErrorDokJan"></asp:RequiredFieldValidator>

                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" 
	                    runat="server" 
                        ControlToValidate="txtAnswerQuestion3_1" 
	                    ErrorMessage="ห้ามเกิน 300 ตัวอักษร"
                         Display="Dynamic"
                ...
                <asp:TextBox ID="txtAnswerQuestion3_2" CssClass="TextArea" runat="server"  TextMode="MultiLine" Rows="7" Columns="70" MaxLength="1500"></asp:TextBox>
                     <asp:RequiredFieldValidator 
                        ...
                        Text="*" 
                         Display="Dynamic"
                          SetFocusOnError="true"
                        ErrorMessage="กรุณากรอกคำตอบข้อ1.2" CssClass="ErrorDokJan"></asp:RequiredFieldValidator>
