<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="projects_incomplete_sim.aspx.cs" Inherits="projects_incomplete_sim" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
การวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล ตามแผนงาน/โครงการ โครงการที่จำลองการกรอกข้อมูล
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
    โครงการที่ยังไม่สมบูรณ์ โครงการที่จำลองการกรอกข้อมูล 
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="dgProject" runat="server" AutoGenerateColumns="false" OnRowDataBound="dgProject_OnRowDataBound">
        <Columns>
            ...
            <asp:HyperLinkField DataTextField ="pj_name" DataNavigateUrlFields ="pj_id" DataNavigateUrlFormatString ="redirectProjects.aspx?pj_id={0}&fm=simnotcomplete" HeaderText="ชื่อโครงการ"  ItemStyle-Width="350px"/>
