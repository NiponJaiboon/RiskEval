...
public partial class project_filter_edit : System.Web.UI.Page
{
        ...
        else
        {
            ...
            foreach (DataRow dRow in dv2.Table.Rows)
            {
                if (dRow[0].ToString() != "0")
                {
                    ...
                    if (radQ1.SelectedIndex == 0 || radQ2.SelectedIndex == 0)
                    {
    ...
    {
            //Response.Redirect("project_basicinfo_edit.aspx");
