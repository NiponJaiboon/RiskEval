...
public partial class question_set_C_edit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (ck != null)
            {
                ...
                string strSQL1 = "select * from question1 q1, question2 q2, question3 q3 where q1.qset_id = 3 and q1.q1_id = q2.q1_id and q2.q2_id = q3.q2_id";
                ...
                mgCookie.UpdateCookies("qset_id", "3"); //คำถามชุด ก.
