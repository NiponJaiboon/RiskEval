<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="project_category.aspx.cs" Inherits="project_category" %>
                ...
                <p class="title">ลักษณะโครงการ</p> 
                    ...
                    <div>
                           <asp:RadioButtonList ID="radProjectCate" runat="server">
                               ...
                               <asp:ListItem Text="บริการชุมชนและสังคม" Value="บริการชุมชนและสังคม"></asp:ListItem>
