<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="project_details_edit.aspx.cs" Inherits="project_details_edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
    ระบุข้อมูลรายละเอียดโครงการ (แก้ไข)
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:SqlDataSource ID="SqlDataSource3" runat="server"
    ...
    <asp:SqlDataSource 
        ...
        ConnectionString="<%$ ConnectionStrings:GovBudgetingConnectionString %>"
         UpdateCommand="update projects set p_id = @p_id, d_id = @d_id, mi_id = @mi_id,pj_name  = @pj_name, pj_yut_id  = @pj_yut_id, pj_year = @pj_year,pj_budget  = @pj_budget, pj_budget_money = @pj_budget_money, pj_lastupdate = getdate(), pj_budget_type = @pj_budget_category where pj_id = @pj_id"></asp:SqlDataSource>
