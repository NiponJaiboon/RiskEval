<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="projects_real_completed_not_submitted.aspx.cs" Inherits="projects_real_completed_not_submitted" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
การวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล ตามแผนงาน/โครงการ โครงการกรอกสมบูรณ์ที่ยังไม่ส่งผลการวิเคราะห์
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
     โครงการกรอกสมบูรณ์ที่ยังไม่ส่งผลการวิเคราะห์
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="dgProject" runat="server" AutoGenerateColumns="false" OnRowDataBound="dgProject_OnRowDataBound">
        <Columns>
            ...
            <asp:HyperLinkField DataTextField ="pj_name" DataNavigateUrlFields ="pj_id" DataNavigateUrlFormatString ="redirectProjects.aspx?pj_id={0}&fm=realnotsubmitted" HeaderText="ชื่อโครงการ"  ItemStyle-Width="350px"/>
