<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="projects_completed_submitted.aspx.cs" Inherits="projects_completed_submitted" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
การวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล ตามแผนงาน/โครงการ โครงการกรอกสมบูรณ์ที่ส่งผลการวิเคราะห์
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
    โครงการกรอกสมบูรณ์ที่ส่งผลการวิเคราะห์
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <asp:GridView ID="dgProject" 
            DataKeyNames="pj_id"
            runat="server" 
            AutoGenerateColumns="false" 
            OnRowDataBound="dgProject_OnRowDataBound">
        <Columns>
           
            <asp:HyperLinkField DataTextField ="pj_name" DataNavigateUrlFields ="pj_id" DataNavigateUrlFormatString ="redirectProjects.aspx?pj_id={0}&fm=submitted" HeaderText="ชื่อโครงการ"  ItemStyle-Width="350px"/>
            ...
            <asp:BoundField HeaderText="ผลการประเมินการวิเคราะห์ความเสี่ยง"  ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Left"/>
