<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/Main.master" AutoEventWireup="true" CodeFile="question_set_A.aspx.cs" Inherits="question_set_A"  MaintainScrollPositionOnPostback="true"%>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
การวิเคราะห์ความเสี่ยงตามหลักธรรมาภิบาล ตามแผนงาน/โครงการ คำถามชุด ก
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentTitle" Runat="Server">
คำถามชุด ก: ขั้นตอนการริเริ่มแผนงาน/โครงการและวิเคราะห์เบื้องต้น
</asp:Content>
 ...
 <asp:Panel ID="panel1" runat="server" Visible="true">
  <div class="box-question">
    <div style="text-align:left; margin-top:10px;">
        ...
        <asp:Literal id="lblAssumption" runat="server"></asp:Literal></div>
        <div style="margin-left:15px; margin-top:15px;">
                ...
                <asp:RadioButtonList ID="radanswer2_1" runat="server"  
                    ...
                    <asp:ListItem Value="มี">ใช่</asp:ListItem>
                    <asp:ListItem Value="ไม่มี">ไม่ใช่</asp:ListItem>
                </asp:RadioButtonList>
   ...
   <div style="text-align:left; margin-top:15px;">
        <div style="color:Red; font-size:20px;" class="QL1"><asp:Literal ID="lblQuestion2" runat="server"></asp:Literal></div>
         <div style="display:none"><asp:Literal id="lblAssumption2" runat="server"></asp:Literal></div>
        <div style="margin-left:15px; margin-top:15px;">
